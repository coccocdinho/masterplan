...
export function rowSt(t) {
  if (done(t)) return { bg: "bg-emerald-50/70", bd: "border-l-4 border-l-emerald-400" };
  const u = urg(t);
  if (u === "over") return { bg: "bg-rose-100/70", bd: "border-l-4 border-l-rose-600" };
  if (u === "today") return { bg: "bg-orange-100/60", bd: "border-l-4 border-l-orange-500" };
  if (u === "soon") return { bg: "bg-amber-100/50", bd: "border-l-4 border-l-amber-400" };
  return { bg: "bg-white", bd: "border-l-4 border-l-transparent" };
}
...
const LM = {
  ...
  sy: { l: "Đồng bộ Sheet", c: "text-sky-700", b: "bg-sky-50" },
};
export { LM };
